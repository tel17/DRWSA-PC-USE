...
if (isset($_POST['update'])) {
    ...
    // Ensure only the user who created the record can update it
    $updateQuery = "UPDATE tbl_or_service_invoice SET date_received='$date_received', teller_name='$teller_name', series='$series', service_invoice='$service_invoice' WHERE id='$id' AND teller_name='$username'";
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card recent-sales overflow-auto">
                        <div class="card-body">
                            <h5 class="card-title">OR Service Invoice | Reports</h5>
                            <div style="display: flex; justify-content: space-between; align-items: center;">
                                <div>
                                    <!-- buttons for print here -->
                                </div>
                                <div>
                ...
                <form action="insert_invoice.php" method="POST" id="addForm">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="teller_name" value="<?php echo htmlspecialchars($username); ?>" readonly required>
                        </div>
                        <div class="form-group">
